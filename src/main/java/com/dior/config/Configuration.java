...
import com.dior.Enum.Device;
import com.dior.Enum.Urls;
...
public class Configuration {
    ...
    public Configuration(){
        ...
        email           = System.getProperty("email", (String) prop.get("email","yoanntagne45@gmail.com"));
        pwd             = System.getProperty("pwd", (String) prop.get("pwd","1995P@oyon"));
